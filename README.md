...
- **Performance:** Algorithm optimization (SIMD, advanced hashing methods), high-performance computing
...
I regularly publish technical articles on my blog, **[gustawdaniel.com](https://gustawdaniel.com)**, where I explore topics ranging from:
- Low-level algorithm optimization and software architecture
- Full-stack TypeScript applications (tRPC, Fastify, Prisma)
- System administration, Linux environments, and CI/CD
- AI integration, LangChain use cases, and GPT-CLI

## 📫 Let's Connect!

I am always open to new opportunities to tackle challenging engineering problems. If you're looking for a dedicated engineer to elevate your product, let's talk!

- **Email:** [gustaw.daniel@gmail.com](mailto:gustaw.daniel@gmail.com)
- **Blog:** [gustawdaniel.com](https://gustawdaniel.com)
